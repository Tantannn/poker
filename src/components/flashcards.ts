...
export const CARDS: Flash[] = [
  ...
  { spot: 'Higher pair vs lower pair', detail: 'e.g. QQ vs 77', equity: 81, hook: '80/20. Lower pair needs its set (~18%) or a runner straight/flush.', recognize: 'BOTH players hold a pocket pair, yours the bigger one (e.g. QQ vs 77). Their main out is flopping a set (~12% by the flop).', cat: 'Preflop' },
